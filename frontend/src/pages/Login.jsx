    ...
    return (
        <div className="login-page">
            ...
            <div className="login-card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="login-form-group">
                        ...
                        {emailError && <div className="error-message" style={{ marginTop: '6px', marginBottom: 0 }}>{emailError}</div>}
                    </div>
                    ...
                    <button type="submit" className="btn-login" disabled={loading}>
                        {loading ? <span className="spinner" /> : (isRegister ? 'Create Account' : 'Sign In to Dashboard')}
                    </button>
                </form>
                ...
                <p className="login-toggle">
                    ...
                    <button
                        ...
                        onClick={() => { setIsRegister(!isRegister); setError(''); setEmailError(''); }}
                    >
            ...
            <div className="login-footer">
                ...
                <br />
                <span style={{ display: 'block', marginTop: '6px' }}>© 2024 VIT Shuttle. Smart Campus Initiative.</span>
            </div>
        </div>
    );
}

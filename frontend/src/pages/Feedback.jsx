...
export default function Feedback() {
  ...
  const hasMoreReviews = totalCount > 5;
  const visibleFeedbacks = showAllReviews ? feedbacks : feedbacks.slice(0, 5);
  const avgRating =
    totalCount > 0
      ...
      <div className="main-content">
        <div className="feedback-page">
          <div className="page-header">
            <h1>Campus Voice</h1>
            <p>
              Help us refine the "Ethereal Navigator" experience. Your feedback
              directly impacts the Smart Campus Initiative.
            </p>
          </div>
            ...
            <div>
              <div className="feedback-list-card">
                <div className="feedback-list-header">
                  <div className="feedback-list-title">💬 Recent Feedback</div>
                ...
                {feedbacks.length === 0 ? (
                  ...
                  visibleFeedbacks.map((fb, i) => (
                    ...
                    >
                      <div className="feedback-item-top">
                        ...
                        <div>
                          <div className="feedback-author-name">
                            {fb.user_name || fb.user_email?.split("@")[0]}
                          </div>
                      ...
                      {fb.message && (
                        <p className="feedback-quote">{fb.message}</p>
                      )}
                    </div>
                  ))
                )}
                ...
                {hasMoreReviews && (
                  <button
                    type="button"
                    className="btn-show-all-feedback"
